...
if test "$1" = "1"; then
  ...
  qubesctl --skip-dom0 --targets=debian-13-minimal state.apply debian-minimal.install
elif test "$1" = "2"; then
  ## Upgrade
  true
fi
...
* Mon Apr 14 2025 wassp <cyberwassp@gmail.com> - 8ef152e
- fix: Fix typos

* Mon Apr 14 2025 wassp <cyberwassp@gmail.com> - d6ba4db
